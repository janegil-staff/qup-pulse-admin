...
const KEYS = {
  ...
  // ââ Chat: one-opener pending gate âââââââââââââââââââââ
  // Shown in the composer BEFORE the user types, not as an error after they
  // send. The rule is not a punishment and should not read like one: it says
  // what happened, what is blocked, and what unblocks it.
  "app.chat.pendingTitle": {
    no: "Venter på svar",
    en: "Waiting for a reply",
    nl: "Wachten op antwoord",
    fr: "En attente d'une réponse",
    de: "Warten auf eine Antwort",
    it: "In attesa di una risposta",
    sv: "Väntar på svar",
    da: "Venter på svar",
    fi: "Odotetaan vastausta",
    es: "Esperando respuesta",
    pl: "Czekamy na odpowiedź",
    pt: "À espera de resposta",
  },
  "app.chat.pendingBody": {
    no: "Du har sendt den første meldingen din. Du kan sende flere når de svarer.",
    en: "You've sent your first message. You can send more once they reply.",
    nl: "Je hebt je eerste bericht verstuurd. Je kunt meer sturen zodra ze reageren.",
    fr: "Vous avez envoyé votre premier message. Vous pourrez en envoyer d'autres dès qu'on vous répondra.",
    de: "Du hast deine erste Nachricht gesendet. Sobald geantwortet wird, kannst du weitere senden.",
    it: "Hai inviato il tuo primo messaggio. Potrai inviarne altri quando ti risponderanno.",
    sv: "Du har skickat ditt första meddelande. Du kan skicka fler när du får svar.",
    da: "Du har sendt din første besked. Du kan sende flere, når du får svar.",
    fi: "Lähetit ensimmäisen viestisi. Voit lähettää lisää, kun sinulle vastataan.",
    es: "Has enviado tu primer mensaje. Podrás enviar más cuando te respondan.",
    pl: "Pierwsza wiadomość została wysłana. Kolejne możesz wysłać po otrzymaniu odpowiedzi.",
    pt: "Enviaste a tua primeira mensagem. Podes enviar mais assim que te responderem.",
  },
  "app.chat.pendingBlocked": {
    no: "Du kan sende en ny melding når de har svart.",
    en: "You can send another message once they reply.",
    nl: "Je kunt pas een nieuw bericht sturen als ze hebben geantwoord.",
    fr: "Vous pourrez envoyer un autre message dès qu'on vous aura répondu.",
    de: "Du kannst eine weitere Nachricht senden, sobald geantwortet wurde.",
    it: "Potrai inviare un altro messaggio quando ti avranno risposto.",
    sv: "Du kan skicka ett nytt meddelande när du har fått svar.",
    da: "Du kan sende en ny besked, når du har fået svar.",
    fi: "Voit lähettää uuden viestin, kun sinulle on vastattu.",
    es: "Podrás enviar otro mensaje cuando te respondan.",
    pl: "Kolejną wiadomość możesz wysłać po otrzymaniu odpowiedzi.",
    pt: "Podes enviar outra mensagem assim que te responderem.",
  },
