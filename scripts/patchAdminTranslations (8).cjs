...
const KEYS = {
  ...
  // ── Chat: one-opener gate ─────────────────────────
  // The initiator gets one message before the recipient accepts; the API 403s
  // the second. Named separately from the existing pendingBody, which is the
  // RECIPIENT-facing copy in the accept banner — the two sides of a pending
  // thread need different words.
  "app.messages.awaitingReplyTitle": {
    no: "Venter på svar",
  ...
  "app.messages.awaitingReplyBody": {
    no: "Du har sendt den første meldingen din. Du kan sende flere når du får svar.",
    en: "You've sent your first message. You can send more once you get a reply.",
    nl: "Je hebt je eerste bericht verstuurd. Je kunt meer sturen zodra je antwoord krijgt.",
    fr: "Vous avez envoyé votre premier message. Vous pourrez en envoyer d'autres dès que vous recevrez une réponse.",
    de: "Du hast deine erste Nachricht gesendet. Sobald du eine Antwort erhältst, kannst du weitere senden.",
    it: "Hai inviato il tuo primo messaggio. Potrai inviarne altri quando riceverai una risposta.",
    ...
    fi: "Lähetit ensimmäisen viestisi. Voit lähettää lisää, kun saat vastauksen.",
    es: "Has enviado tu primer mensaje. Podrás enviar más cuando recibas una respuesta.",
    pl: "Pierwsza wiadomość została wysłana. Kolejne możesz wysłać po otrzymaniu odpowiedzi.",
    pt: "Enviaste a tua primeira mensagem. Podes enviar mais assim que receberes resposta.",
  },
  // ── Chat: image gate ───────────────────────────────
